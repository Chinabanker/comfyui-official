...
- **Official ComfyUI** ([github.com/Comfy-Org/ComfyUI](https://github.com/Comfy-Org/ComfyUI)) pinned to **v0.37.2** + **ComfyUI-Manager** (official)
...
- **comfy-aimdo 0.5.5** — DynamicVRAM with NVML pressure awareness (model reload/regression fixes)
...
- comfy-aimdo 0.5.5, comfy-kitchen 0.2.35
