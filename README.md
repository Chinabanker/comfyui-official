...
- **Official ComfyUI** ([github.com/Comfy-Org/ComfyUI](https://github.com/Comfy-Org/ComfyUI)) pinned to **v0.35.0** + **ComfyUI-Manager** (official)
...
- **comfy-aimdo 0.5.3** — DynamicVRAM with NVML pressure awareness (model reload/regression fixes)
