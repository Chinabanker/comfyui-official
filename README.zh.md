...
- **官方 ComfyUI**（[github.com/Comfy-Org/ComfyUI](https://github.com/Comfy-Org/ComfyUI)）锁定 **v0.37.0** + 官方 **ComfyUI-Manager**
...
- **comfy-aimdo 0.5.5** — 具备 NVML 压力感知的 DynamicVRAM（修复模型重载/性能回退问题）
