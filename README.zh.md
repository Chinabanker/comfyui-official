...
- **官方 ComfyUI**（[github.com/Comfy-Org/ComfyUI](https://github.com/Comfy-Org/ComfyUI)）锁定 **v0.35.1** + 官方 **ComfyUI-Manager**
...
- **comfy-aimdo 0.5.3** — 具备 NVML 压力感知的 DynamicVRAM（修复模型重载/性能回退问题）
